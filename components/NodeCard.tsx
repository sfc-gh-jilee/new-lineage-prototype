      ...
      {hasErrors && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            <path fillRule="evenodd" clipRule="evenodd" d="M10.4854 1C10.7505 1.00002 11.0049 1.10545 11.1924 1.29297L14.707 4.80762C14.8946 4.99514 15 5.24946 15 5.51465V10.4854C15 10.7505 14.8946 11.0049 14.707 11.1924L11.1924 14.707C11.0049 14.8946 10.7505 15 10.4854 15H5.51465C5.24946 15 4.99514 14.8946 4.80762 14.707L1.29297 11.1924C1.10545 11.0049 1.00002 10.7505 1 10.4854V5.51465C1.00002 5.24946 1.10545 4.99514 1.29297 4.80762L4.80762 1.29297C4.99514 1.10545 5.24946 1.00002 5.51465 1H10.4854ZM4 7.5V8.5H12V7.5H4Z" fill="#D3132F"/>
          </svg>
            ...
            <div style={{ marginBottom: hasWarnings ? 12 : 0 }}>
              <div style={{ fontWeight: 600, marginBottom: 8, color: '#1e252f', display: 'flex', alignItems: 'center', gap: 4 }}>
                <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
                  <path fillRule="evenodd" clipRule="evenodd" d="M10.4854 1C10.7505 1.00002 11.0049 1.10545 11.1924 1.29297L14.707 4.80762C14.8946 4.99514 15 5.24946 15 5.51465V10.4854C15 10.7505 14.8946 11.0049 14.707 11.1924L11.1924 14.707C11.0049 14.8946 10.7505 15 10.4854 15H5.51465C5.24946 15 4.99514 14.8946 4.80762 14.707L1.29297 11.1924C1.10545 11.0049 1.00002 10.7505 1 10.4854V5.51465C1.00002 5.24946 1.10545 4.99514 1.29297 4.80762L4.80762 1.29297C4.99514 1.10545 5.24946 1.00002 5.51465 1H10.4854ZM4 7.5V8.5H12V7.5H4Z" fill="#dc2626"/>
                </svg>
